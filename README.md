...
<p align="center">
  <video src="gameplay.gif" width="700" alt="ADHDventure gameplay GIF" controls autoplay loop muted></video>
</p>
...
1. **Install Godot:** Ensure you have the [Godot Engine](https://godotengine.org/download/) installed (check the `project.godot` file for the exact version, likely Godot 3.x or 4.x).
...
4. **Play:** Hit the play button (`F5`) inside the editor to run the game locally!

## 🗣️ Feedback & Suggestions

Since this is my first game and a work in progress, I would absolutely love your feedback. If you encounter bugs or have ideas for new features, please let me know!

📝 **[Submit your rating and feedback here](https://forms.gle/PUKS4WRAXJgBumfu5)**
